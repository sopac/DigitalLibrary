...
class PublicationController {
    ...
    def en_list() {
        params.max = Math.min(params.max ? params.int('max') : 10, 100)
        [publicationInstanceList: Publication.findAllByLanguage("EN", params), publicationInstanceTotal: Publication.count()]
    }

    def fr_list() {
        params.max = Math.min(params.max ? params.int('max') : 10, 100)
        [publicationInstanceList: Publication.findAllByLanguage("FR", params), publicationInstanceTotal: Publication.count()]
    }
